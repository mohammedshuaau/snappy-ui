...
export const LineChart = React.forwardRef<HTMLDivElement, LineChartProps>(
    ({
        ...
        const chartClassName = sx ? `line-chart-${Math.random().toString(36).slice(2, 11)}` : '';
                ...
                >
                    ...
                    {series.map((s) => (
                        <Line
                            ...
                            stroke={getVariantColor(s.variant || variant || 'default', isDarkMode)}
